...
const userService= {
    ...
    async getBlogsByUserId(request) {
        ...
        //KONTROLLER
        dtos.baseResponse.data = await userDal.getBlogsByUserId(userId)
    ...
    async updatePhoto(request) {
        ...
        const findedUser = await userDal.findById(userId)
    ...
    async findByEmail(request) {
        ...
        const { email } = request.body  //json body'den alır : request.body
